...
- (DownloadHelper *)downloadHelper
{
    ...
    if (helper == nil)
    {
        //lazy loading of the helper class
...
-(void)didCompleteDownloadForURL:(NSString *)url
                        withData:(NSMutableData *)data
{
    ...
    if (image == nil)
    {
        //something didn't work out - data may be corrupted or a bad url
        return;
    }
...
- (void)setImageWithRemoteFileURL:(NSString *)urlString
                 placeHolderImage:(UIImage *)placeholderImage
{
    ...
    self.downloadHelper.connection =(NSURLConnection *)[[NSURLConnection alloc] initWithRequest:request
                                                                                       delegate:self.downloadHelper
