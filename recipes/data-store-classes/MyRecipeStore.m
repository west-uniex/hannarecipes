...
static MyRecipeStore *defaultStore = nil;

@implementation MyRecipeStore
         ...
         withImage: (UIImage *) theRecipeImage
{
    ...
    [[MyImageStore defaultImageStore] setImage:theRecipeImage forKey:key];
...
- (void)removeRecipe:( Recipe *) recipe
{
    ...
    [[MyImageStore defaultImageStore] deleteImageForKey:key];
...
- (NSString *) recipesArchivePath
{
    ...
    return pathInDocumentDirectory(@"myrecipes.data");
}
