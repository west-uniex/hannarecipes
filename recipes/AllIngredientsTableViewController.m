//
//  AllIngredientsTableViewController.m
//  recipes
//
...
@interface AllIngredientsTableViewController ()

@end

@implementation AllIngredientsTableViewController
...
- (void)viewDidLoad
{
    ...
    // AllIngredientsNavigationController *nc = self.presentingViewController;
}
...
{
    static NSString *CellIdentifier = @"AllIngredientsCellIdentifier";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier forIndexPath:indexPath];
    
    // Configure the cell...
    cell.textLabel.text = (NSString *)[self.allIngredients objectAtIndex:indexPath.row];
